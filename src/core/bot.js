  ...
  try {
    ...
    if (response && response.ok && response.result) {
      for (const update of response.result) {
        ...
        updaterService.lazyCheckUpdate(bot).catch(() => {});
      }
    }
  } catch (err) {
...
async function start() {
  ...
  updaterService.notifyStartupUpdate(bot);
...
module.exports = {
  lazyCheckUpdate: (b) => updaterService.lazyCheckUpdate(b),
  getLastCheckTime: () => updaterService.getLastCheckTime(),
  setLastCheckTime: (t) => updaterService.setLastCheckTime(t),
  getLastNotifiedVersion: () => updaterService.getLastNotifiedVersion(),
  setLastNotifiedVersion: (v) => updaterService.setLastNotifiedVersion(v),
  start
};
